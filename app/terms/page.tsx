    ...
    <main style={{ background: '#0D0D0D', minHeight: '100vh', color: '#F5F5F5' }}>
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '64px 24px' }}>
        ...
        {[
          ...
          {
            n: '5', title: 'IPFS and permanence',
            body: 'Approved artefacts are stored on IPFS, a decentralised network. Once content is published, its content identifier (CID) is permanent and may remain accessible even if the artefact is later removed from this site. We can unpin content from our infrastructure but cannot guarantee removal from the broader IPFS network. This is a property of the technology, not a limitation of our moderation.',
          },
          {
